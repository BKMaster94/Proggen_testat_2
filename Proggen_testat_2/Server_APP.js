...
////////////////////////////////////////////////////////////////////////////// Alles folgt dem Gleichen Prinzip ! daher keine Genauere Kommentierung mehr!
...
//////////////////////////////////////////////////////////////////////////////
				if((SpielerFeldID[1] === 1 && SpielerFeldID[4] === 1 && SpielerFeldID[7] === 1) || (SpielerFeldID[1] === 0 && SpielerFeldID[4] === 0 && SpielerFeldID[7] === 0 )){ // Erkennung ob der Spieler Gewonnen hat || Senkrecht Mitte !
					zuege = 0;
...
//////////////////////////////////////////////////////////////////////////////
				if((SpielerFeldID[2] === 1 && SpielerFeldID[5] === 1 && SpielerFeldID[8] === 1) || (SpielerFeldID[2] === 0 && SpielerFeldID[5] === 0 && SpielerFeldID[8] === 0 )){ // Erkennung ob der Spieler Gewonnen hat || Senkrecht Rechts !
					zuege = 0;
...
//////////////////////////////////////////////////////////////////////////////
				if((SpielerFeldID[0] === 1 && SpielerFeldID[4] === 1 && SpielerFeldID[8] === 1) || (SpielerFeldID[0] === 0 && SpielerFeldID[4] === 0 && SpielerFeldID[8] === 0 )){ // Erkennung ob der Spieler Gewonnen hat || Quer Oben Links Unten Rechts !
					zuege = 0;
					io.emit('Gewonnen' , SpielerFeldID[0]+1);
...
//////////////////////////////////////////////////////////////////////////////
				if((SpielerFeldID[2] === 1 && SpielerFeldID[4] === 1 && SpielerFeldID[6] === 1) || (SpielerFeldID[2] === 0 && SpielerFeldID[4] === 0 && SpielerFeldID[6] === 0 )){ // Erkennung ob der Spieler Gewonnen hat || Quer Oben Rechts Unten Links !
					zuege = 0;
					io.emit('Gewonnen' , SpielerFeldID[2]+1);
...
//////////////////////////////////////////////////////////////////////////////
				...
				if(zuege === 9){ // Wenn alle Züge erreicht worden sind und kein Gewinner gezogen wird ist das Spiel unentschieden
					zuege = 0; // Alles wird zurück gesetzt
					io.emit('Gewonnen' , 'Unentschieden'); // Ein Unentschieden Text wird zu den Clients geschickt
